...
<body>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="#tabel">ORDERS</a>
                </li>
              </ul>
              <form class="d-flex">
    ...
    <section id="tabel">
        <table class="table">
            <h3 style="text-align: center;">TABEL ORDERAN</h3>
            <thead>
              <tr>
                <th scope="col">NO</th>
            ...
            <tbody>
              <tr>
                <th scope="row">1</th>
                <td>ARSYA</td>
                <td>arsya@gmail.com</td>
                <td>Jogja</td>
                <td>Chariz Black</td>
                <td>1,minus kanan kiri (1)</td>
                <td>Bank Transfer</td>
                <td>RP 109.000</td>
              </tr>
              <tr>
              ...
              <tr>
                  <th scope="row">3</th>
                  <td>Arsal</td>
                  <td>arsaleldeva@gmail.com</td>
                  <td>Semarang</td>
                  <td>AGNES B</td>
                  <td>2,minus 2(kiri) minum 0,5 (kanan)</td>
                  <td>BANK TRANSFER</td>
                  <td>Rp 220.000</td>
              </tr>
            </tbody>
        ...
        <br><br>
        <h4 style="text-align: center;">progress order : input orderan</h4>
        <div class="progress">
        ...
        <br><br><br>
        <div class="mapouter">
        <div class="gmap_canvas"><iframe width="600" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=ALUN%20ALUN%20BATANG&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://putlocker-is.org">putlocker</a><br><style>.mapouter{position:relative;text-align:right;height:500px;width:600px;}</style><a href="https://www.embedgooglemap.net">embedgooglemap.net</a><style>.gmap_canvas {overflow:hidden;background:none!important;height:500px;width:600px;}</style></div></div>
